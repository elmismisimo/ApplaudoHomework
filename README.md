...
The project structure is based on MVC, so the packages of the project are arranged in this terms. Those files that i didnt thought fitted as a view, model or a controler, went to the root folder or the utils package, depending on it functionality.
